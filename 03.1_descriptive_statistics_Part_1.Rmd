...
output:
  xaringan::moon_reader:
    self-contained: false  # Временно отключаем самодостаточность
    lib_dir: libs
    ...
    nature:
      ...
      # Добавьте эту строку для загрузки Remark.js из CDN:
      sourceURL: "https://remarkjs.com/downloads/remark-latest.min.js"
    includes:
