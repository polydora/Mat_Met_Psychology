...
**Ваша миссия:** Используя переведенные в длинный формат данные по водному тесту, построить столбчатую диаграмму, которая будет отражать среднее количество яиц в гнездах на разных островах. Образец, к которому надо стремиться приведен [здесь](HW2_templ.html).
