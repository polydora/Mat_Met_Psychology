...
![:scale 100%](images/normal_distribution_by_humans.png)
**Распределение случайной величины** — это правило (закон), которое описывает, с какой вероятностью могут появляться те или иные значения случайной величины.
